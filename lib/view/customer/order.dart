                            ...
                            children: menu.tag.split(",").map((e){
                              return Chip(
                                ...
                                labelStyle: TextStyle(
                                  color: choice.selectedOption == e ? Colors.white : Colors.black
                                ),
                                side: BorderSide(
                            ...
                            child: ElevatedButton(
                              onPressed: (){
                                if(menu.iceHot != "-" && choice.selectedOption.isEmpty){
                                  ...
                                  Provider.of<CartController>(context, listen: false).addCart(
                                    {
                                      "menu" : menu,
                                      "qty" : Provider.of<CounterController>(context, listen: false).amount,
                                      "ice_hot" : Provider.of<ChipSelectionController>(context, listen: false).selectedOption
                                    }
                                  );
